...
function Planet(props) {
  ...
  const handleDelete = () => {
    onDelete(name); // Call the onDelete function with the planet's name
  };
...
function PlanetContainer() {
  ...
  const handleDelete = (planetName) => {
    // Filter out the planet with the specified name
...
ReactDOM.render(<PlanetContainer />, rootElement);